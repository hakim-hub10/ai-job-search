...
export default async function Page({ params, searchParams }: { params: Promise<{ applicationId: string; sessionId: string }>; searchParams: Promise<{ answerError?: string | string[]; skipError?: string | string[] }> }) {
  ...
  return <MockInterviewView applicationId={applicationId} result={await loadApplicationMockInterview(applicationId, sessionId)} answerAction={submitMockInterviewAnswerAction} skipAction={skipMockInterviewQuestionAction}
